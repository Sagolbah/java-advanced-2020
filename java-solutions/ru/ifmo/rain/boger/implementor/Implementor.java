...
/**
 * Implementation class for interface {@link JarImpler}
 *
...
public class Implementor implements JarImpler {
    ...
    /**
     * Creates {@link Implementor} instance
     */
    public Implementor() {
    }
    ...
    /**
     * Runs {@link Implementor} with one of possible ways, depending on given arguments:
     * <ul>
     *     <li><code>className rootDir</code> - executes {@link #implement(Class, Path)} with given arguments</li>
     *     <li><code>-jar className rootDir</code> - executes {@link #implementJar(Class, Path)} with arguments
     *          <code>className, rootDir</code></li>
     * </ul>
    ...
    public static void main(String[] args) {
        if (args == null || (args.length != 2 && args.length != 3)) {
            System.out.println("Usage: java Implementor <classPath> <outputPath>  //  java Implementor -jar <cP> <oP>");
            return;
        }
        for (String arg : args) {
            if (arg == null) {
